 ...
 *
 * This file contains the upvote script for AJAX calls.
 *
 * Aaron Mitchell 2018
...
require_once("commentboard.php");
			...
			// If this is not a signed-in user, no upvote.
...
if ($_SERVER['REQUEST_METHOD'] !== 'POST') {			
 ...
 die();
			...
			// If this board does not exist, no upvote.
...
if ( !file_exists(RLC_SECRET_PATH."/boards/".$_POST["ancestor"]) ) {
 ...
 die();
			...
			// If this comment does not exist, no upvote.
	...
	$_POST["ancestor"]."/".$_POST["id"].".txt") ) 
{
 ...
 die();
			...
			// instantiate and load the comment and upvote.

$comment = new Comment($_POST["ancestor"]);
$comment->load($_POST["id"]);
if ( $comment->upvote($username) ) {
